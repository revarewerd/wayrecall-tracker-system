...
- [🤖 AI Agent Instructions — Wayrecall Tracker](#-ai-agent-instructions--wayrecall-tracker)
  - [📑 Содержание](#-содержание)
  - [1. Правила общения](#1-правила-общения)
    - [Обязательно (MUST DO)](#обязательно-must-do)
    - [Запрещено (MUST NOT)](#запрещено-must-not)
    - [Поведение при неопределённости](#поведение-при-неопределённости)
  - [2. Правила оформления кода](#2-правила-оформления-кода)
    - [Именование](#именование)
    - [Структура package](#структура-package)
    - [Форматирование (пример)](#форматирование-пример)
  - [3. Общие принципы](#3-общие-принципы)
    - [MUST DO](#must-do)
    - [MUST NOT](#must-not)
  - [4. Описание проекта](#4-описание-проекта)
    - [Ключевые бизнес-сценарии](#ключевые-бизнес-сценарии)
  - [5. Структура проекта и папок](#5-структура-проекта-и-папок)
    - [Верхний уровень](#верхний-уровень)
    - [Структура внутри сервиса (Scala)](#структура-внутри-сервиса-scala)
    - [Не коммитить в git](#не-коммитить-в-git)
  - [6. Технический стек](#6-технический-стек)
  - [7. Архитектурные цели и SLA](#7-архитектурные-цели-и-sla)
    - [Принципы надёжности](#принципы-надёжности)
  - [8. Ответственности сервисов](#8-ответственности-сервисов)
    - [Block 1 — Data Collection](#block-1--data-collection)
    - [Block 2 — Business Logic](#block-2--business-logic)
    - [Block 3 — Presentation (в дизайне)](#block-3--presentation-в-дизайне)
    - [Правила разграничения](#правила-разграничения)
  - [9. Инфраструктура и шины данных](#9-инфраструктура-и-шины-данных)
    - [Kafka Topics](#kafka-topics)
    - [Redis: кэширование и очереди](#redis-кэширование-и-очереди)
    - [Порты](#порты)
  ...
  - [11. ФП принципы (Scala + ZIO)](#11-фп-принципы-scala--zio)
    ...
    - [Примеры и справка](#примеры-и-справка)
  ...
  - [15. Система документирования сервисов](#15-система-документирования-сервисов)
    ...
    - [Обязательные файлы в `services/[name]/docs/`](#обязательные-файлы-в-servicesnamedocs)
  - [16. Синхронизация документов между сервисами](#16-синхронизация-документов-между-сервисами)
    - [Процесс утверждения инфраструктурных сущностей](#процесс-утверждения-инфраструктурных-сущностей)
    - [Матрица синхронизации](#матрица-синхронизации)
    - [Чеклист при изменении сервиса](#чеклист-при-изменении-сервиса)
...
| Concurrent GPS trackers | 10,000+ | На весь кластер |
| GPS points/sec | 10,000+ | Без потерь |
...
| Data retention | 90 дней | GPS история — потом архив |

### Принципы надёжности

- Retry с exponential backoff для Redis/Kafka операций
- Circuit breaker для внешних интеграций (Wialon, webhooks)
